        ...
        */
        struct Filter
        {
            ...
            public void FiltFromConsole()
            {
                ...
                {
                    //установка значения фильтрации по номеру рейса
                    case ("1"):
                    ...
                    case ("2"):
                        ...
                        break;
                        //Установка значения фильтрации по дате вылета
                    case ("3"):
                    ...
                    case ("4"):
                        ...
                        break;
                    //Установка значения фильтрации по дате прилета
                    case ("5"):
                    ...
                    case ("8"):
                        ...
                        break;
                    //Установка значения фильтрации по расстоянию
                    case ("9"):
